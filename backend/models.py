from sqlalchemy import Column, Integer, String, Boolean, Float, DateTime, UniqueConstraint, Index
...
class Departure(Base):
    ...
    __table_args__ = (
        ...
        ('idx_line_scheduled', 'line', 'scheduled'), # speed up queries with line
        ('idx_stop_scheduled', 'stop_id', 'scheduled'), # speed up queries by stop and time
    )